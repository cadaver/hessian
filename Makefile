...
hessian.d64: hessian.seq loader.prg main.pak options.bin emptysave.bin savelist.bin \
...
letter.pak: bg/letter.chr letter.s mainsym.s
	dasm letter.s -oletter.bin -f3
	pack2 letter.bin letter.pak
