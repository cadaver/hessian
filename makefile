...
main.pak: actor.s actordata.s bullet.s data.s file.s init.s item.s level.s macros.s main.s memory.s \
    panel.s physics.s player.s raster.s screen.s sound.s sounddata.s sprite.s weapon.s weapondata.s \
    loader.pak bg/scorescr.chr sfx/pistol.sfx sfx/explosion.sfx sfx/throw.sfx sfx/melee.sfx
