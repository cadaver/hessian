...
hessian.d64: boot.prg loader.pak main.pak loadpic.pak options.bin emptysave.bin savelist.bin logo.pak \
	...
	music08.pak music09.pak music10.pak music11.pak script00.pak level00.pak level01.pak common.pak item.pak \
	weapon.pak player.pak
